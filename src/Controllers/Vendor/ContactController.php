...
final class ContactController
{
    public function index(Request $req): void
    {
        ...
        View::render('vendor.contacts.index', compact('contacts'));
    }
    ...
    public function show(Request $req, string $id): void
    {
        ...
        View::render('vendor.contacts.show', compact('contact', 'states'));
    }
    ...
    public function updateStatus(Request $req, string $id): void
    {
        ...
        if (!$statusRepo->existsById($statusId)) {
            ...
            Response::redirect(route('vendor.contacts.show', ['id' => $id]));
        }
