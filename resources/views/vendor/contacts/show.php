...
/** @var object $contact */
/** @var array $states */
$title = 'Consulta ' . htmlspecialchars((string)$contact->numero_ticket, ENT_QUOTES, 'UTF-8') . ' - Vendedor';
...
<div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
  ...
  <a class="btn btn--sm" href="<?= htmlspecialchars(route('vendor.contacts.index'), ENT_QUOTES, 'UTF-8') ?>">← Volver</a>
</div>
...
<div class="panel" style="margin-top:14px;">
  <div class="panel__body">
    ...
    <form method="POST" action="<?= htmlspecialchars(route('vendor.contacts.status', ['id' => $contact->id_contacto]), ENT_QUOTES, 'UTF-8') ?>" style="margin-top:12px; display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
...
<div class="panel" style="margin-top:14px;">
  <div class="panel__body">
    ...
    <form method="POST" action="<?= htmlspecialchars(route('vendor.contacts.respond', ['id' => $contact->id_contacto]), ENT_QUOTES, 'UTF-8') ?>">
      <input type="hidden" name="_token" value="<?= htmlspecialchars(\App\Core\Session::csrfToken(), ENT_QUOTES, 'UTF-8') ?>">
      <div class="form__row">
